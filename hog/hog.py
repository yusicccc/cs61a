...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            morescorezero = take_turn(strategy0(score0, score1), score1, dice)
            score0 += morescorezero
        elif player == 1:
            morescoreone = take_turn(strategy1(score1, score0), score0, dice)
            score1 += morescoreone
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    i = 1
    while i < 11:
        ave = make_averaged(roll_dice)(i,dice)
        if ave > maxave:
            maxave = ave
            max = i
        i += 1
